...
namespace PtsTaiwan\LaravelNewebpaySDK;

use Throwable;
use PtsTaiwan\LaravelNewebpaySDK\Exceptions\NewebpayDecodeFailException;
...
class NewebPay extends BaseNewebPay
{
     ...
     * @return \PtsTaiwan\LaravelNewebpaySDK\NewebPayMPG
     */
     ...
     *         'order' => 使用商店訂單編號追蹤
     *         'trade' => 使用藍新金流交易序號追蹤
     * @return \PtsTaiwan\LaravelNewebpaySDK\NewebPayCancel
     */
     ...
     *         'order' => 使用商店訂單編號追蹤
     *         'trade' => 使用藍新金流交易序號追蹤
     * @return \PtsTaiwan\LaravelNewebpaySDK\NewebPayClose
     */
     ...
     * @param  string  $no 訂單編號
     * @param  int  $amt 訂單金額
     * @return \PtsTaiwan\LaravelNewebpaySDK\NewebPayQuery
     */
     ...
     * @return \PtsTaiwan\LaravelNewebpaySDK\NewebPayCreditCard
     */
     ...
     * @return mixed
     *
     * @throws \PtsTaiwan\LaravelNewebpaySDK\Exceptions\NewebpayDecodeFailException
     */
